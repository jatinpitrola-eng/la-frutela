    ...
    >
      ...
      <div className="relative mx-auto grid max-w-7xl items-center gap-12 px-4 pb-20 pt-10 sm:px-6 lg:grid-cols-2 lg:gap-6 lg:px-8 lg:pb-28 lg:pt-16">
        ...
        <motion.div
          ...
          className="relative order-1 mx-auto aspect-square w-[300px] sm:w-[400px] lg:order-2 lg:w-[500px]"
        >
          {/* glow */}
          ...
          {/* sundae disc */}
          <div className="absolute inset-[13%] overflow-hidden rounded-full ring-8 ring-gold/50 shadow-[0_40px_80px_-20px_rgba(66,12,22,0.45)]">
            <Image
          ...
          {SPARKLES.map((s, i) => (
            <span
              key={i}
              aria-hidden
              className={`animate-twinkle pointer-events-none absolute text-gold ${s.size}`}
