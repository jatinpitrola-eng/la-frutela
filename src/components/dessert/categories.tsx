          ...
          {CATEGORIES.map((cat, i) => (
            ...
            >
              <motion.button
                ...
                className="shine-sweep group relative flex h-full w-full flex-col justify-end overflow-hidden rounded-[1.75rem] text-left shadow-lg shadow-maroon/10 ring-1 ring-gold/30 transition-[box-shadow] duration-500 hover:shadow-2xl hover:shadow-maroon/25 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-gold"
